...
<body>
    ...
    <form name="memberForm" action='save.html' method='post'>
        ...
        <div>
            ...
            <input type="text" name="id" name="name" placeholder="아이디를 입력하세요">
            <span class="error" id=errorId" style="display:none">아이디를 입력하세요</span>
        </div>  
        <div>
            <label for="email">이메일</label>
            <input type="email" name="email" name="email" placeholder="이메일을 입력하세요">
            <span class="error" id="errorEmail" style="display:none">이메일을 입력하세요</span>
        </div>
        <div>
            <label for="pwd">비밀번호</label>
            <input type="password" name="pwd" name="pwd" placeholder="비밀번호를 입력하세요">
